...
#     cursor = conn.cursor()
#     cursor.execute("SELECT * FROM Students")
#     students = cursor.fetchall()  # This returns a list of tuples (each tuple = one row)
...
#     cursor = conn.cursor()
    ...
    # # 5 query
    # cursor.execute("SELECT * FROM Students WHERE age = 22 AND major = 'History'")
    # students = cursor.fetchall()
    # print("\nStudents 22-years old, who taking History:")
    # for student in students:
    #     print(student)
...
with sqlite3.connect("db/school.db") as conn:
    ...
    # Call the function inside the with block
